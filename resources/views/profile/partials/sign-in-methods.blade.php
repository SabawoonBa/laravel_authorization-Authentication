        ...
        <div class="card-body border-top p-9">
            ...
            <div class="d-flex flex-wrap align-items-center">
                ...
                <div id="kt_signin_email_edit" class="flex-row-fluid d-none">
                    <!--begin::Form-->
                    <form method="POST" action="{{ route('profile.patch.email') }}" class="form" novalidate="novalidate">
                        @csrf
                        <div class="row mb-6">
            ...
            <div class="d-flex flex-wrap align-items-center mb-10">
                ...
                <div id="kt_signin_password_edit" class="flex-row-fluid d-none">
                    <!--begin::Form-->
                    <form method="POST" action="{{ route('profile.patch.password') }}" class="form" novalidate="novalidate">
                        @csrf
                        <div class="row mb-1">
                            <div class="col-lg-4">
                                <div class="fv-row mb-0">
                                    ...
                                    @error('current_password')
                                        <div class="fv-plugins-message-container">
                                            <div data-field="current_password" data-validator="notEmpty" class="fv-help-block">Please enter the current password.</div>
                                        </div>
                                    @enderror
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="fv-row mb-0">
                                    ...
                                    @error('new_password')
                                        <div class="fv-plugins-message-container">
                                            <div data-field="new_password" data-validator="notEmpty" class="fv-help-block">Please enter the new password.</div>
                                        </div>
                                    @enderror
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="fv-row mb-0">
                                    ...
                                    @error('new_password_confirmation')
                                        <div class="fv-plugins-message-container">
                                            <div data-field="new_password_confirmation" data-validator="notEmpty" class="fv-help-block">Please confirm the new password.</div>
                                        </div>
                                    @enderror
                                </div>
                            </div>
...
<!--end::Sign-in Method-->
@include('modals.two-factor-auth-modal')
