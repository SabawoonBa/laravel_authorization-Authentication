        ...
        <div id="kt_app_toolbar" class="app-toolbar pt-7 pt-lg-10">
            ...
            <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                ...
                <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                    ...
                    <!--end::Breadcrumb-->
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bolder fs-3 m-0">eCommerce Dashboard</h1>
                    <!--end::Title-->
                </div>
                <!--end::Page title-->
                <!--begin::Actions-->
                            ...
                            <div class="m-0">
                                ...
                                <div class="d-flex flex-stack mb-9">
                                    ...
                                    <div class="d-flex align-items-center me-2">
                                        ...
                                        <div class="symbol symbol-50px me-5">
                                            <div class="symbol-label bg-light">
                                                <img src="{{ asset('assets/media/svg/brand-logos/telegram-2.svg') }}" class="h-50" alt="" />
                                            </div>
                                        </div>
                                        <!--end::Symbol-->
                                        <!--begin::Title-->
